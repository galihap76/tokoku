...
@section('title', 'Tambah Sub Kategori Produk - ' . env('APP_NAME'))
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-auto mt-4">
                    <h1 class="page-header-title">
                        <div class="page-header-icon"><i class="bi bi-plus-circle-fill" style="font-size: 25px;"></i>
                        </div>
                        Tambah Sub Kategori
                    </h1>
                    <div class="page-header-subtitle">Tokoku - Tambah Sub Kategori Produk</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-xl px-4 mt-n10">
    <div class="row">
        <div class="col">
            ...
            <div id="default">
                <div class="card mb-4">
                    <div class="card-header">Form Tambah Sub Kategori Produk</div>
                    <div class="card-body">
                        ...
                        <div class="sbp-preview">
                            <div class="sbp-preview-content">
                                <form method="post" action="{{ route('categories-submenu.store') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('label') is-invalid @enderror" id="label"
                                            name="label" rows="2" required>{{ old('label') }}</textarea>
                                        @error('label')
                                        <p class="mt-2 text-danger"><i class="bi bi-exclamation-octagon-fill"></i> {{
                                            ucfirst($message) }}</p>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mt-2 text-danger"><i class="bi bi-exclamation-octagon-fill"></i> {{
                                            ucfirst($message) }}</p>
                                        @enderror
                                        <small class="text-muted">* Kosongkan jika tidak ingin mengupload.</small>
                                    </div>
